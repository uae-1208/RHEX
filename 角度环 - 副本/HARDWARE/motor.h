...
//zhp
#define Motor_Prescaler      1560//当前使用的电机  //5764  //RHEX使用的电机编码器分辨率 11*131*4
...
#define motor1_speed_integral_max      300

#define motor1_angle_kp 			   0.5    //zhp
#define motor1_angle_ki 			   0
#define motor1_angle_kd 			   0 
#define motor1_angle_dead_band 	       0
#define motor1_angle_outmax 		   45
