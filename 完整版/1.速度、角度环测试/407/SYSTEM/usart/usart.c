...
#define motor_dead_band  475  //0.88v
			 ...
			 Motor_t* motor3,Motor_t* motor4,Motor_t* motor5,Motor_t* motor6)
{
	...
	Set_PWM_Value[0] = motor1->pwm_out;   
	Set_PWM_Value[1] = motor2->pwm_out;
	Set_PWM_Value[2] = motor3->pwm_out;
	Set_PWM_Value[3] = motor4->pwm_out;
	Set_PWM_Value[4] = motor5->pwm_out;
	Set_PWM_Value[5] = motor6->pwm_out;
...
//	
//	if(motor1->pwm_out < 0)
//		Set_PWM_Value[0] = motor1->pwm_out - motor_dead_band;
//	else
//		Set_PWM_Value[0] = motor1->pwm_out + motor_dead_band;
//	
//	if(motor2->pwm_out < 0)
//		Set_PWM_Value[1] = motor2->pwm_out - motor_dead_band;
//	else
//		Set_PWM_Value[1] = motor2->pwm_out + motor_dead_band;	
//	
//	if(motor3->pwm_out < 0)
//		Set_PWM_Value[2] = motor3->pwm_out - motor_dead_band;
//	else
//		Set_PWM_Value[2] = motor3->pwm_out + motor_dead_band;
//	
//	if(motor4->pwm_out < 0)
//		Set_PWM_Value[3] = motor4->pwm_out - motor_dead_band;
//	else
//		Set_PWM_Value[3] = motor4->pwm_out + motor_dead_band;
//	
//	if(motor5->pwm_out < 0)
//		Set_PWM_Value[4] = motor5->pwm_out - motor_dead_band;
//	else
//		Set_PWM_Value[4] = motor5->pwm_out + motor_dead_band;

//	if(motor6->pwm_out < 0)
//		Set_PWM_Value[5] = motor6->pwm_out - motor_dead_band;
//	else
//		Set_PWM_Value[5] = motor6->pwm_out + motor_dead_band;
//		
//	for(i=0;i<6;i++)
//		LimitPwm(Set_PWM_Value[i]);
